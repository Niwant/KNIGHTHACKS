  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1.5 pt-1">
        ...
        <Button
          type="submit"
          className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-1.5 rounded-md flex items-center justify-center gap-1.5 text-xs font-medium border-none h-8"
        >
